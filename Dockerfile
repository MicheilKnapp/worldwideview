...
ARG NEXT_PUBLIC_WWV_FORCE_GLOBAL_ENGINE
...
RUN set +e ; { \
        ...
        if [ -n "$NEXT_PUBLIC_WWV_FORCE_GLOBAL_ENGINE" ]; then echo "NEXT_PUBLIC_WWV_FORCE_GLOBAL_ENGINE=$NEXT_PUBLIC_WWV_FORCE_GLOBAL_ENGINE" ; fi ; \
